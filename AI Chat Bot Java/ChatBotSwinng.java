...
public class ChatBotSwinng extends JFrame implements KeyListener
{
	...
	String chatBot[][] = {
			...
			{"Hello there! Study Sea is 24/7 online for you","Hello dear!", "Yes, say"},
			//question 1: 
			...
			//default
			{"Definitely!", "Absolutely!", "Sure!", "Oh, yes"}
		...
		if(arg0.getKeyCode() == KeyEvent.VK_ENTER)
		{
			...
			*/
			...
			if( response==1 )
			{
				...
				addText("\n--> Study Sea:\t " + chatBot[ chatBot.length-1 ][r] );
			}
		}
	}

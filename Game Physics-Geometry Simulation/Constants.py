...
AchievementBoxes = [
    AchievementBox(60, 250, 150, 100, 'POPPER', False, [0, ACH_IDEALS['POPPER'], 'Ballons popped'], gameDisplay,
                   evManager=Controller),
    AchievementBox(220, 250, 150, 100, 'SPEED', False, [0, ACH_IDEALS['SPEED'], 'Maxiumum speed reached'], gameDisplay,
                   evManager=Controller),
    AchievementBox(380, 250, 150, 100, 'COLLIDER', False, [0, ACH_IDEALS['COLLIDER'], 'Maxiumum collision speed'],
                   gameDisplay, evManager=Controller),
    AchievementBox(60, 400, 150, 100, 'NODER', False, [0, ACH_IDEALS['NODER'], 'Nodes built'], gameDisplay,
                   evManager=Controller),
    AchievementBox(220, 400, 150, 100, 'EDGER', False, [0, ACH_IDEALS['EDGER'], 'Edges built'], gameDisplay,
                   evManager=Controller),
    AchievementBox(380, 400, 150, 100, 'FACER', False, [0, ACH_IDEALS['FACER'], 'Faces built'], gameDisplay,
                   evManager=Controller)
    ]
